    ...
    <div>
          ...
          <template #default="scope">
            ...
            >
              <div
                ...
                @click="viewPetPostDetail(scope.row.id)"
              >
      ...
      <div class="pager">
        <el-pagination
          ...
          :current-page="petPostQueryDto.current"
          :page-sizes="[10, 20]"
          :page-size="petPostQueryDto.size"
      ...
      <div class="post-detail-container">
        ...
        <div class="post-header">
          ...
          <div class="post-meta">
            ...
            <el-tag
              :type="petPost.isAudit ? 'success' : 'warning'"
              size="small"
            >
        ...
        <div class="post-stats">
          <span
            ...
            {{ petPost.viewNumber || 0 }} 浏览</span
          >
          <span
            ><i class="el-icon-thumb"></i>
            {{ petPost.upvoteNumber || 0 }} 点赞</span
          >
          <span
            ><i class="el-icon-star-off"></i>
            {{ petPost.saveNumber || 0 }} 收藏</span
          >
        </div>
    ...
    handleAudit() {
      this.$confirm("确定要通过此帖子的审核吗?", "审核确认", {
        ...
        .then(() => {
          try {
            this.$axios
              .put(`/pet-post/audit/${this.petPost.id}`)
              .then(response => {
