<template>
  <div class="container">
    ...
    <div>
      <el-table :data="apiResult.data">
        ...
        <el-table-column prop="isReply" width="110" label="回复状态">
          <template #default="scope">
            <el-tag
              :type="scope.row.isReply ? 'success' : 'info'"
              size="mini"
              >{{ scope.row.isReply ? "已回复" : "未回复" }}</el-tag
            >
          </template>
        </el-table-column>
            ...
            >
              ...
              >
                <div
                  ...
                  @click="viewproposalFeedbackDetail(scope.row)"
                >
      ...
      <div class="pager">
        <el-pagination
          ...
          :current-page="proposalFeedbackQueryDto.current"
          :page-sizes="[10, 20]"
          :page-size="proposalFeedbackQueryDto.size"
    ...
    >
      <div
        style="padding: 10px;margin: 0 20px;background-color: rgb(245,246,247);"
      >
        <div
          style="margin-bottom: 10px;display: flex;justify-content: left;align-items: center;gap: 10px;"
        >
          <img
            style="width: 20px;height: 20px;border-radius: 50%;"
            :src="proposalFeedback.avatar"
            alt=""
            srcset=""
          />
      ...
      <div style="margin-inline: 20px;margin-block: 10px;">
        <el-input
          :disabled="proposalFeedback.isReply"
          type="textarea"
          :rows="3"
          placeholder="回复内容"
        ...
        <div
          v-if="proposalFeedback.isReply"
          style="font-size: 14px;margin-block: 10px;"
        >
