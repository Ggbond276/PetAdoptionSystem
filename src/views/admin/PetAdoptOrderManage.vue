    ...
    >
      <div style="margin: 10px 20px;">
        ...
        <div
          ...
          v-if="petAdoptOrder.status !== 2 && petAdoptOrder.status !== 4"
        >
          <el-button @click="auditSuccess" icon="el-icon-success" type="success"
            >审核通过</el-button
          >
          <el-button
