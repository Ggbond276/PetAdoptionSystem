  ...
  <div class="main-contianer">
    <div class="left">
      ...
      <div class="chart-top">
        ...
        <div class="pie">
          <PieCharts height="500px" :data="petTypeCountList" />
        </div>
      </div>
    </div>
    <div class="right">
      <div v-for="(item, index) in petList" :key="index">
        ...
        <div
          @click="viewPetDetail(item.id)"
          style="margin-block: 10px;font-size: 20px;cursor: pointer;"
        >
          {{ item.name }}
        </div>
      </div>
