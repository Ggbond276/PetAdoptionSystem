<template>
  <div class="container">
    ...
    <div>
      ...
      <div class="pager">
        <el-pagination
          ...
          :current-page="addressQueryDto.current"
          :page-sizes="[10, 20]"
          :page-size="addressQueryDto.size"
    ...
    <el-drawer
      ...
      :title="drawerOperation ? '收货地址修改' : '收货地址新增'"
      :visible.sync="drawer"
      :direction="direction"
    >
      <div style="padding: 10px 20px;">
        ...
        <el-input
          ...
          :rows="3"
          placeholder="详细地址描述"
          v-model="apiParam.detail"
        >
        </el-input>
        <h5>是否是默认地址</h5>
        <el-switch
          v-model="apiParam.isDefault"
          active-color="#13ce66"
          inactive-color="#ff4949"
        >
        </el-switch>
        <div
          v-if="!drawerOperation"
          class="primary-bt"
          style="margin-inline: 0;text-align: center;margin-top: 20px;"
          @click="saveMyAddress"
        >
          新增收货地址
        </div>
